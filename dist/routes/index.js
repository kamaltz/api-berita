...
router.use("/news", bookmarkRoutes_1.default);
        ...
        endpoints: {
            ...
            news: {
                ...
                getTrendingArticles: {
                    ...
                    description: "Mendapatkan artikel berita yang sedang trending",
                },
                getArticleById: {
                    method: "GET",
                    path: "/api/v1/news/:id",
                ...
                createArticle: {
                    method: "POST",
                    path: "/api/v1/news",
                    description: "Membuat artikel berita baru (memerlukan autentikasi)",
                    auth: "Bearer Token",
                    body: {
                        title: "string (required)",
                ...
                updateArticle: {
                    method: "PUT",
                    path: "/api/v1/news/:id",
                    description: "Memperbarui artikel berita (memerlukan autentikasi)",
                    auth: "Bearer Token",
                ...
                deleteArticle: {
                    method: "DELETE",
                    path: "/api/v1/news/:id",
                    description: "Menghapus artikel berita (memerlukan autentikasi)",
                    auth: "Bearer Token",
                },
            },
            bookmarks: {
